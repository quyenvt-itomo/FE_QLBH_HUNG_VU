import { CountryData } from "@/shared/interfaces/format";
import { country_options } from "../../constants/option/country";
...
interface CountrySelectProps extends SelectProps {
  onChangeData?: (data: CountryData | undefined) => void;
}
...
const CountrySelect: React.FC<CountrySelectProps> = ({
  ...
  const listCountry: CountryData[] = [
    ...
    { name: "Congo (Brazzaville)", code: "CG", phoneCode: "+242" },
    { name: "Congo (Kinshasa)", code: "CD", phoneCode: "+243" },
    ...
    { name: "Việt Nam", code: "VN", phoneCode: "+84" },
    { name: "Yemen", code: "YE", phoneCode: "+967" },
    { name: "Zambia", code: "ZM", phoneCode: "+260" },
    { name: "Zimbabwe", code: "ZW", phoneCode: "+263" },
    { name: "Khác", code: "OTHER", phoneCode: "" },
  ];

  const handleChange = (value: string) => {
    onChange?.(value);
    const data = listCountry.find((item) => item.name === value);
    onChangeData?.(data);
  };
