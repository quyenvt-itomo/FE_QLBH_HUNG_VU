...
import FloatLabel from "@/shared/components/display/FloatLabel";
      ...
      <div className="h-full w-full max-w-[1440px] flex justify-center items-center p-12 gap-16">
        ...
        <div className="w-[446px] flex-shrink-0">
          <div className="flex justify-center items-center gap-4">
            ...
            <span className="text-4xl font-mono font-bold">{APP_NAME}</span>
          </div>
          ...
          >
            ...
            <div className="flex justify-between">
              <Form.Item
                ...
                noStyle
              >
                <Checkbox className="text-secondary">Giữ tôi luôn đăng nhập</Checkbox>
              </Form.Item>
