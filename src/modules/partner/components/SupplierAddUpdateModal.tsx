...
const SupplierAddUpdateModal: React.FC<PartnerFormModalProps> = ({
  open,
  editData,
  loading,
  errors,
    ...
    <Modal
      ...
      title={
        <div className="flex items-center justify-between gap-4">
          <span>{`${editData ? "Cập nhật" : "Thêm mới"} nhà cung cấp`}</span>
          <SubmitButton
            loading={loading}
...
export default SupplierAddUpdateModal;
export { SupplierAddUpdateModal };
