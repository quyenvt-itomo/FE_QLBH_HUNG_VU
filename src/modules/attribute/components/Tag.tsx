...
const styleMap: Record<AttributeType, TagStyleValue> = {
  ...
  [AttributeType.PRODUCT_GROUP]: tagStyle("geekblue"),
  [AttributeType.BRAND]: tagStyle("yellow"),
  [AttributeType.LOCATION]: tagStyle("cyan"),
  ...
  [AttributeType.CUSTOMER_GROUP]: tagStyle("blue"),
  [AttributeType.SUPPLIER_GROUP]: tagStyle("green"),
  [AttributeType.SHIPPER_GROUP]: tagStyle("cyan"),
};
