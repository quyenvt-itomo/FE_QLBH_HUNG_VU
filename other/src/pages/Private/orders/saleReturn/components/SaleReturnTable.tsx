...
const SaleReturnTable: React.FC<ObjectTableProps> = ({
  dataSource,
  summaryData,
  pagination,
  ...rest
  ...
  const columns: any = [
    ...
    {
      title: "Khách TT",
      dataIndex: ["incomeExpenses", 0, "amount"],
    ...
    {
      title: "Quỹ nhận",
      dataIndex: ["incomeExpenses", 0, "fund", "name"],
  ...
  return (
    <TableColumnConfig
      ...
      itemName={"đơn khách trả"}
      tableKey={`sale-return-table${currentStore ? `-store` : ""}`}
      hasSummary
