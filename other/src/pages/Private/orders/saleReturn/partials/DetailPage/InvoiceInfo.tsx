...
const InvoiceInfo: React.FC<PartialProps> = ({ data, itemForm }) => {
  ...
  function calculateFee() {
    ...
    const returnLines = items.filter((line) => line.lineType === OrderLineTypeEnum.RETURN);
    const normalLines = items.filter(
  ...
  return (
    <div className="flex flex-col bg-white rounded-lg p-4 flex-1">
