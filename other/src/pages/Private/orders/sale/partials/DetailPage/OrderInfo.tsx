  ...
  return (
    <div className="flex flex-col bg-white border rounded-lg p-4 pb-0">
      ...
      <EditableInfoRow<IOrder>
        ...
        fieldKey="partnerId"
        required
        editComponent={<CustomerSelect defaultData={data.partner} />}
        onUpdate={onUpdate}
      />
      ...
      <EditableInfoRow<IOrder>
        label="Điểm sử dụng"
        value={formatQuantity(data.loyaltyPointsUsed)}
        fieldKey="loyaltyPointsUsed"
        editComponent={<InputQuantity notRightAlign />}
        onUpdate={onUpdate}
      />
