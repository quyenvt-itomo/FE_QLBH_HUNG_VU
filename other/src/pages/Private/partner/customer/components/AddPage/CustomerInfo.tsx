...
export const CustomerInfo: React.FC<CustomerInfoProps> = ({ form, onFormChange }) => {
  ...
  useEffect(() => {
    setFormCode({ form, type: "customer", field: "code" });
  }, []);
    ...
    <div className="flex flex-col">
      ...
      <Row className="px-8 pt-6" gutter={[108, 28]}>
        <Col lg={12} xs={24} className="space-y-2">
          <Form.Item
            name="code"
            label={<Label width={164} title="Mã khách hàng" required />}
            rules={[
              {
                required: true,
          ...
          <Form.Item
            name="name"
            label={<Label width={164} title="Tên khách hàng" required />}
            rules={[
              {
                required: true,
        ...
        <Col lg={12} xs={24} className="space-y-2">
          <Form.Item
            name="groupId"
            label={<Label width={164} title="Nhóm khách hàng" required />}
            rules={[
              {
                required: true,
