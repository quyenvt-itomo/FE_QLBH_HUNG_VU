...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  description = "Manage your sales, customers, and inventory all in one place with ease and efficiency.",
  buttonText = "Continue",
}) => {
  ...
  return (
    <div className="flex items-center justify-center h-full md:h-[calc(100vh-300px)] overflow-y-auto md:px-8">
      <div className="max-w-6xl w-full bg-white rounded-3xl shadow-lg p-12 flex flex-col md:flex-row items-center justify-between">
        <div className="flex-1 max-w-md">
          ...
          <p className="text-gray-400 mb-8 leading-relaxed slide-right" style={getDelayStyle(2)}>
            {description}
          </p>
