...
import { SideBarMenuItems } from "../../Private/sidebar/components/MenuItem";
...
const AppHeader: React.FC = () => {
  ...
  return (
    <Header
      className="
    bg-white m-0 h-12 md:my-3 md:h-16 flex flex-row justify-between items-center
    ...
    >
      <div className="h-8 w-8">
        ...
        h-8 w-8 rounded-full border-[#F2F2F5] ${
