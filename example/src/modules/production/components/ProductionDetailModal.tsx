...
export const ProductionDetailModal: React.FC<Props> = ({ open, data, onClose, onOpenUpdate }) => {
  ...
  return (
    <Modal title={"Chi tiết Lệnh sản xuất"} open={open} onCancel={onClose} footer={onOpenUpdate ? <button className="text-blue-500 hover:underline text-sm" onClick={()=>onOpenUpdate(data)}>Chỉnh sửa</button> : null} width={700} destroyOnClose>
